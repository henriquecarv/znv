...
import { ErrorWithContext, makeDefaultReporter, Reporter, TokenFormatters } from "./reporter.js";
 ...
 */
export const inferSchemas = <T extends Schemas & RestrictSchemas<T>>(schemas: T): T & RestrictSchemas<T> => schemas;
